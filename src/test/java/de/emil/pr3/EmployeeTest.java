...
public class EmployeeTest {
    ...
    public void fistNameShouldNotBeNull() {
        assertThrows(IllegalArgumentException.class, () -> new Employee(null, "lastName"));
    }

    @Test
    public void fistNameShouldNotBeBlank() {
        assertThrows(IllegalArgumentException.class, () -> new Employee("   ", "LastName"));
    }

    @Test
    public void lastNameShouldNotBeNull() {
        assertThrows(IllegalArgumentException.class, () -> new Employee("firstName", null));
    }

    @Test
    public void lastNameShouldNotBeBlank() {
        assertThrows(IllegalArgumentException.class, () -> new Employee("firstName", "   "));
    }
